...
\end{center}
The policy evaluation/iteration algorithm takes 5 iterations to converge. Changing the value of \texttt{ct} does not change the number of iterations until convergence. This is intuitive because policy evaluation/iteration should converge to the optimal policy exactly when it converges. 
\newpage
...
\begin{center}
        ...
        \hline
        Time per iteration & 0.682 & 0.467\\
        \hline
        Overall runtime & 3.409 & 11.7\\
        \hline
        \end{tabular}
\end{center}
...
Total time: 2.2740695476531982
Average time per step: 0.4548342704772949

Converged at iteration 5
Policy iteration complete.
Total time: 3.6058311462402344
Average time per step: 0.7212543487548828

Converged at iteration 6
Policy iteration complete.
Total time: 6.238354921340942
Average time per step: 1.2476888656616212

Converged at iteration 6
Policy iteration complete.
Total time: 9.72501015663147
Average time per step: 1.9451001167297364
